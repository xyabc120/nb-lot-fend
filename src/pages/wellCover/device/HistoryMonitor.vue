...
<div class="monitor">
    <div class="filter mb20">
        ...
        <div>
            <label>时间范围</label>
            <el-date-picker v-model="filter.createDate" type="daterange" align="right" unlink-panels value-format="yyyy-MM-dd" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="pickerOptions" @change="query()"></el-date-picker>
        </div>
    </div>
    <div class="table">
        <el-table v-if="!!monitorList" :data="monitorList" style="width: 100%" :header-cell-style="{background:'#eef1f6',color:'#606266'}">
...
export default {
    ...
    methods: {
        ...
        exportData(){
          let api = "/monitor/exportWellCoverMonitorById";
            let params = {
                deviceId: this.id,
                ...this.filter
            };
